      ...
      default:
        ...
        if (isAuthenticated) {
          ...
          if (user?.role === 'student') {
            items.push({ href: "/my-courses", label: "My Courses" });
          }
        } else {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <Link href={getLogoLink()} className="flex items-center gap-2 group">
              <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-orange-500 to-orange-600 flex items-center justify-center shadow-lg shadow-orange-500/30 group-hover:shadow-orange-500/50 transition-shadow">
              ...
              {isAuthenticated && user ? (
                ...
                !loading && (
                  <div className="flex items-center gap-2">
                    ...
                    <Link
                      href="/register"
                      className="px-4 py-2 text-sm font-medium text-white bg-gradient-to-r from-orange-500 to-orange-600 rounded-lg hover:from-orange-600 hover:to-orange-700 transition-all shadow-md shadow-orange-500/30"
                    >
                      Sign Up
                    </Link>
                  </div>
