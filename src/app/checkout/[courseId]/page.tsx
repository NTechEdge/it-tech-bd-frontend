...
export default function CheckoutPage() {
  ...
  // Handle params.courseId being an array or undefined
  const courseId = typeof params.courseId === 'string' ? params.courseId : Array.isArray(params.courseId) ? params.courseId[0] : null;
  ...
  const checkForAvailableCoupon = useCallback(async () => {
    // Don't proceed if courseId is not available yet
    if (!courseId) {
      console.log('CourseId not available yet, skipping coupon check');
      return;
    }
      ...
      <PublicLayout>
        <div className="min-h-screen flex items-center justify-center">
          <div className="text-center">
            <h2 className="text-2xl font-bold text-gray-900 mb-2">Invalid Course</h2>
            <p className="text-gray-600 mb-4">Course ID is missing. Please select a course.</p>
            <button
