        ...
        <div className="space-y-6">
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <p className="text-sm text-gray-600 mb-4">
              Ensure your password is strong and contains at least 6 characters.
            </p>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <p className="text-sm text-gray-600 mb-4">
              You are currently logged in on this device. If you notice any suspicious activity, please contact the administrator immediately.
            </p>
